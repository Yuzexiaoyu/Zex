    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-6" onClick={onClose}>
      ...
      >
        <div className="flex items-start justify-between px-6 py-5 border-b border-border-glass shrink-0">
          <div>
            <h2 className="text-lg font-bold">选择正确的条目</h2>
            <p className="mt-1 text-xs text-text-secondary">
              「{title}」在 TMDB 上有 {results.length} 个同名/相近结果，选中的那条会用于获取简介、评分和剧照
            </p>
          </div>
          <button
            onClick={onClose}
              ...
              >
                ...
                <div className="min-w-0 flex-1 text-left">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {isCurrent && <span className="badge badge-accent">当前匹配</span>}
                  </div>
